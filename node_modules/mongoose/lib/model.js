...
const ChangeStream = require('mongoose/lib/cursor/changeStream');
...
const MongooseBulkWriteError = require('mongoose/lib/error/bulkWriteError');
const MongooseError = require('mongoose/lib/error');
const ObjectParameterError = require('mongoose/lib/error/objectParameter');
const OverwriteModelError = require('mongoose/lib/error/overwriteModel');
const Query = require('mongoose/lib/query');
const SaveOptions = require('mongoose/lib/options/saveOptions');
const Schema = require('mongoose/lib/schema');
const ValidationError = require('mongoose/lib/error/validation');
const VersionError = require('mongoose/lib/error/version');
const ParallelSaveError = require('mongoose/lib/error/parallelSave');
const applyDefaultsHelper = require('mongoose/lib/helpers/document/applyDefaults');
const applyDefaultsToPOJO = require('mongoose/lib/helpers/model/applyDefaultsToPOJO');
const applyEmbeddedDiscriminators = require('mongoose/lib/helpers/discriminator/applyEmbeddedDiscriminators');
const applyHooks = require('mongoose/lib/helpers/model/applyHooks');
const applyMethods = require('mongoose/lib/helpers/model/applyMethods');
const applyProjection = require('mongoose/lib/helpers/projection/applyProjection');
const applyReadConcern = require('mongoose/lib/helpers/schema/applyReadConcern');
const applySchemaCollation = require('mongoose/lib/helpers/indexes/applySchemaCollation');
const applyStaticHooks = require('mongoose/lib/helpers/model/applyStaticHooks');
const applyStatics = require('mongoose/lib/helpers/model/applyStatics');
const applyTimestampsHelper = require('mongoose/lib/helpers/document/applyTimestamps');
const applyWriteConcern = require('mongoose/lib/helpers/schema/applyWriteConcern');
const applyVirtualsHelper = require('mongoose/lib/helpers/document/applyVirtuals');
const assignVals = require('mongoose/lib/helpers/populate/assignVals');
const castBulkWrite = require('mongoose/lib/helpers/model/castBulkWrite');
const clone = require('mongoose/lib/helpers/clone');
const createPopulateQueryFilter = require('mongoose/lib/helpers/populate/createPopulateQueryFilter');
const decorateUpdateWithVersionKey = require('mongoose/lib/helpers/update/decorateUpdateWithVersionKey');
const getDefaultBulkwriteResult = require('mongoose/lib/helpers/getDefaultBulkwriteResult');
const getSchemaDiscriminatorByValue = require('mongoose/lib/helpers/discriminator/getSchemaDiscriminatorByValue');
const discriminator = require('mongoose/lib/helpers/model/discriminator');
const each = require('mongoose/lib/helpers/each');
const get = require('mongoose/lib/helpers/get');
const getConstructorName = require('mongoose/lib/helpers/getConstructorName');
const getDiscriminatorByValue = require('mongoose/lib/helpers/discriminator/getDiscriminatorByValue');
const getModelsMapForPopulate = require('mongoose/lib/helpers/populate/getModelsMapForPopulate');
const immediate = require('mongoose/lib/helpers/immediate');
const internalToObjectOptions = require('mongoose/lib/options').internalToObjectOptions;
const isDefaultIdIndex = require('mongoose/lib/helpers/indexes/isDefaultIdIndex');
const isIndexEqual = require('mongoose/lib/helpers/indexes/isIndexEqual');
const isTimeseriesIndex = require('mongoose/lib/helpers/indexes/isTimeseriesIndex');
const {
  getRelatedDBIndexes,
  getRelatedSchemaIndexes
} = require('mongoose/lib/helpers/indexes/getRelatedIndexes');
const decorateDiscriminatorIndexOptions = require('mongoose/lib/helpers/indexes/decorateDiscriminatorIndexOptions');
const isPathSelectedInclusive = require('mongoose/lib/helpers/projection/isPathSelectedInclusive');
const leanPopulateMap = require('mongoose/lib/helpers/populate/leanPopulateMap');
const parallelLimit = require('mongoose/lib/helpers/parallelLimit');
const prepareDiscriminatorPipeline = require('mongoose/lib/helpers/aggregate/prepareDiscriminatorPipeline');
const pushNestedArrayPaths = require('mongoose/lib/helpers/model/pushNestedArrayPaths');
const removeDeselectedForeignField = require('mongoose/lib/helpers/populate/removeDeselectedForeignField');
const setDottedPath = require('mongoose/lib/helpers/path/setDottedPath');
const util = require('util');
const utils = require('mongoose/lib/utils');
const minimize = require('mongoose/lib/helpers/minimize');
const MongooseBulkSaveIncompleteError = require('mongoose/lib/error/bulkSaveIncompleteError');
const ObjectExpectedError = require('mongoose/lib/error/objectExpected');
const decorateBulkWriteResult = require('mongoose/lib/helpers/model/decorateBulkWriteResult');
...
Model.hydrate = function(obj, projection, options) {
  ...
  const document = require('mongoose/lib/queryHelpers').createModel(this, obj, projection);
