...
const $exists = require('mongoose/lib/schema/operators/exists.js');
const $type = require('mongoose/lib/schema/operators/type.js');
const MongooseError = require('mongoose/lib/error/mongooseError.js');
const SchemaArrayOptions = require('mongoose/lib/options/schemaArrayOptions.js');
const SchemaType = require('mongoose/lib/schemaType.js');
const CastError = SchemaType.CastError;
const Mixed = require('mongoose/lib/schema/mixed.js');
const VirtualOptions = require('mongoose/lib/options/virtualOptions.js');
const VirtualType = require('mongoose/lib/virtualType.js');
const arrayDepth = require('mongoose/lib/helpers/arrayDepth.js');
const cast = require('mongoose/lib/cast.js');
const clone = require('mongoose/lib/helpers/clone.js');
const getConstructorName = require('mongoose/lib/helpers/getConstructorName.js');
const isOperator = require('mongoose/lib/helpers/query/isOperator.js');
const util = require('util');
const utils = require('mongoose/lib/utils.js');
const castToNumber = require('mongoose/lib/schema/operators/helpers.js').castToNumber;
const createJSONSchemaTypeDefinition = require('mongoose/lib/helpers/createJSONSchemaTypeDefinition.js');
const geospatial = require('mongoose/lib/schema/operators/geospatial.js');
const getDiscriminatorByValue = require('mongoose/lib/helpers/discriminator/getDiscriminatorByValue.js');
...
function SchemaArray(key, cast, options, schemaOptions) {
  // lazy load
  EmbeddedDoc || (EmbeddedDoc = require('mongoose/lib/types/index.js').Embedded);
  ...
  if (cast) {
    ...
    const Types = require('mongoose/lib/schema/index.js');
...
SchemaArray.prototype.cast = function(value, doc, init, prev, options) {
  // lazy load
  MongooseArray || (MongooseArray = require('mongoose/lib/types/index.js').Array);
