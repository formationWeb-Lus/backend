...
const QueryCursor = require('mongoose/lib/cursor/queryCursor');
const ValidationError = require('mongoose/lib/error/validation');
const { applyGlobalMaxTimeMS, applyGlobalDiskUse } = require('mongoose/lib/helpers/query/applyGlobalOption');
const handleReadPreferenceAliases = require('mongoose/lib/helpers/query/handleReadPreferenceAliases');
...
const castArrayFilters = require('mongoose/lib/helpers/update/castArrayFilters');
const castNumber = require('mongoose/lib/cast/number');
...
const isInclusive = require('mongoose/lib/helpers/projection/isInclusive');
const isPathSelectedInclusive = require('mongoose/lib/helpers/projection/isPathSelectedInclusive');
const isSubpath = require('mongoose/lib/helpers/projection/isSubpath');
const mpath = require('mpath');
const mquery = require('mquery');
const parseProjection = require('mongoose/lib/helpers/projection/parseProjection');
const removeUnusedArrayFilters = require('mongoose/lib/helpers/update/removeUnusedArrayFilters');
const sanitizeFilter = require('mongoose/lib/helpers/query/sanitizeFilter');
const sanitizeProjection = require('mongoose/lib/helpers/query/sanitizeProjection');
const selectPopulatedFields = require('mongoose/lib/helpers/query/selectPopulatedFields');
const setDefaultsOnInsert = require('mongoose/lib/helpers/setDefaultsOnInsert');
const specialProperties = require('mongoose/lib/helpers/specialProperties');
const updateValidators = require('mongoose/lib/helpers/updateValidators');
const util = require('util');
const utils = require('mongoose/lib/utils');
const queryMiddlewareFunctions = require('mongoose/lib/constants').queryMiddlewareFunctions;
