...
const ArrayMethods = require('mongoose/lib/types/array/methods');
const DocumentArrayMethods = require('mongoose/lib/types/documentArray/methods');
...
const arrayParentSymbol = require('mongoose/lib/helpers/symbols').arrayParentSymbol;
const arrayPathSymbol = require('mongoose/lib/helpers/symbols').arrayPathSymbol;
const arraySchemaSymbol = require('mongoose/lib/helpers/symbols').arraySchemaSymbol;
