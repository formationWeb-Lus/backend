...
const DivergentArrayError = require('mongoose/lib/error/divergentArray');
...
const MixedSchema = require('mongoose/lib/schema/mixed');
const ModifiedPathsSnapshot = require('mongoose/lib/modifiedPathsSnapshot');
...
const ParallelValidateError = require('mongoose/lib/error/parallelValidate');
...
const $__hasIncludedChildren = require('mongoose/lib/helpers/projection/hasIncludedChildren');
const applyDefaults = require('mongoose/lib/helpers/document/applyDefaults');
const cleanModifiedSubpaths = require('mongoose/lib/helpers/document/cleanModifiedSubpaths');
const clone = require('mongoose/lib/helpers/clone');
const compile = require('mongoose/lib/helpers/document/compile').compile;
const defineKey = require('mongoose/lib/helpers/document/compile').defineKey;
const firstKey = require('mongoose/lib/helpers/firstKey');
const flatten = require('mongoose/lib/helpers/common').flatten;
const getEmbeddedDiscriminatorPath = require('mongoose/lib/helpers/document/getEmbeddedDiscriminatorPath');
const getKeysInSchemaOrder = require('mongoose/lib/helpers/schema/getKeysInSchemaOrder');
const getSubdocumentStrictValue = require('mongoose/lib/helpers/schema/getSubdocumentStrictValue');
const handleSpreadDoc = require('mongoose/lib/helpers/document/handleSpreadDoc');
const immediate = require('mongoose/lib/helpers/immediate');
const isBsonType = require('mongoose/lib/helpers/isBsonType');
const isDefiningProjection = require('mongoose/lib/helpers/projection/isDefiningProjection');
const isExclusive = require('mongoose/lib/helpers/projection/isExclusive');
...
const markArraySubdocsPopulated = require('mongoose/lib/helpers/populate/markArraySubdocsPopulated');
const minimize = require('mongoose/lib/helpers/minimize');
const mpath = require('mpath');
const parentPaths = require('mongoose/lib/helpers/path/parentPaths');
const queryhelpers = require('mongoose/lib/queryHelpers');
const utils = require('mongoose/lib/utils');
const isPromise = require('mongoose/lib/helpers/isPromise');
...
const documentArrayParent = require('mongoose/lib/helpers/symbols').documentArrayParent;
const documentIsModified = require('mongoose/lib/helpers/symbols').documentIsModified;
const documentModifiedPaths = require('mongoose/lib/helpers/symbols').documentModifiedPaths;
const documentSchemaSymbol = require('mongoose/lib/helpers/symbols').documentSchemaSymbol;
const getSymbol = require('mongoose/lib/helpers/symbols').getSymbol;
const modelSymbol = require('mongoose/lib/helpers/symbols').modelSymbol;
const populateModelSymbol = require('mongoose/lib/helpers/symbols').populateModelSymbol;
const scopeSymbol = require('mongoose/lib/helpers/symbols').scopeSymbol;
const schemaMixedSymbol = require('mongoose/lib/schema/symbols').schemaMixedSymbol;
const getDeepestSubdocumentForPath = require('mongoose/lib/helpers/document/getDeepestSubdocumentForPath');
const sessionNewDocuments = require('mongoose/lib/helpers/symbols').sessionNewDocuments;
...
Document.prototype.$__set = function(pathToMark, path, options, constructing, parts, schema, val, priorVal) {
  Embedded = Embedded || require('mongoose/lib/types/arraySubdocument');
  ...
  if (shouldModify) {
    ...
    MongooseArray || (MongooseArray = require('mongoose/lib/types/array'));
...
Document.prototype.$__getArrayPathsToValidate = function() {
  DocumentArray || (DocumentArray = require('mongoose/lib/types/documentArray'));
